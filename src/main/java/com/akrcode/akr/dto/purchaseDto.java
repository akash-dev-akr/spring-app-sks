...
public class purchaseDto {
	...
	private Integer purchsed_qty;
	private Integer purchsed_value;
	...
	private Date date;
	private Date purchaseupdated_at;
	private Date stockupdated_at;
	public Long getId() {
		return id;
	}
	...
	public Integer getPurchsed_qty() {
		return purchsed_qty;
	}
	public void setPurchsed_qty(Integer purchsed_qty) {
		this.purchsed_qty = purchsed_qty;
	}
	public Integer getPurchsed_value() {
		return purchsed_value;
	}
	public void setPurchsed_value(Integer purchsed_value) {
		this.purchsed_value = purchsed_value;
	}
	...
	public Date getPurchaseupdated_at() {
		return purchaseupdated_at;
	}
	public void setPurchaseupdated_at(Date purchaseupdated_at) {
		this.purchaseupdated_at = purchaseupdated_at;
	}
	public Date getStockupdated_at() {
		return stockupdated_at;
	}
	public void setStockupdated_at(Date stockupdated_at) {
		this.stockupdated_at = stockupdated_at;
	}
